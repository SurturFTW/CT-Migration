            ...
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <div className="flex justify-end mt-4 space-x-3">
                ...
                <button
                  ...
                  className="border-2 border-black text-black px-4 py-2 rounded-xl hover:bg-gray-100 transition flex items-center text-base disabled:opacity-50 disabled:cursor-not-allowed"
