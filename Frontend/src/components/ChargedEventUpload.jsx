...
function ChargedEventUpload() {
    ...
    const FEATURE_ENABLED = false; // Set to true when ready to enable
                        ...
                        <div className="p-4">
                            <div className="mb-4">
                                <p className="text-gray-600">
                                    Showing {data.previewEvents.length} events
                                    from your data. These events will be
                                    uploaded as "Charged" events to CleverTap.
                                </p>
                            ...
                            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-sm text-blue-800">
                                    ...
                                    <li>
                                        ...
                                        : Always "Charged" for purchase events
                                    </li>
                                    <li>
                                        <span className="font-medium">
                                            evtData properties
                                        </span>
                                        : Transaction-level properties like
                                        Amount, Currency
                                    </li>
                                    <li>
                                        <span className="font-medium">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <input
                                    type="text"
                                    value={
                                        specialMappings.identityFieldMapping ||
                                        "identity"
                                    }
                                    onChange={(e) =>
                                        handleSpecialMappingChange(
                                ...
                                <select
                                    value={
                                        specialMappings.identityFieldType ||
                                        "string"
                                    }
                                    onChange={(e) =>
                                        handleSpecialMappingChange(
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <input
                                    type="text"
                                    value={
                                        specialMappings.timestampFieldMapping ||
                                        "ts"
                                    }
                                    onChange={(e) =>
                                        handleSpecialMappingChange(
                                ...
                                <select
                                    value={
                                        specialMappings.timestampFieldType ||
                                        "integer"
                                    }
                                    onChange={(e) =>
                                        handleSpecialMappingChange(
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            Used to group related items into one transaction
                            (Required)
                        </p>
                    </div>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                <div className="p-4 bg-gray-50 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                        Select columns to map as Event Data Properties or Item
                        Fields
                    </p>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm max-w-2xl mx-auto mb-6">
                    ...
                    <div className="p-5">
                        ...
                        <div className="text-left mb-4">
                            ...
                            <p className="text-sm text-gray-600">
                                Processing Time:{" "}
                                {uploadStats.processingTime || "N/A"}
                            </p>
                        </div>
    ...
    // Show coming soon if feature is not enabled
    if (!FEATURE_ENABLED) {
        return (
            <ComingSoon
                featureName="Charged Event Upload"
                ...
                <div className="max-w-6xl mx-auto w-full">
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-lg text-gray-600">
                            Transform your transaction data into CleverTap
                            charged events
                        </p>
                    </div>
